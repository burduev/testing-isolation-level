...
import com.jedi.isolationlevel.isolation.phantomread.BasePhantomRead;
...
public class PhantomReadControllerTest extends BaseIsolationControllerTest {
    ...
    public void setupAll() {
        ...
        System.out.println("---------------------------------------------------------");
        System.out.println("[Не возникает Dirty Read]  Количество " + expectOccur.getCorrectCount());    // 2
        System.out.println("[Возникает Dirty Read]     Количество " + expectOccur.getIncorrectCount());  // 3
        System.out.println("=========================================================");
    }
