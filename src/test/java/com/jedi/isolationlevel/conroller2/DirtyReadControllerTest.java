...
import com.jedi.isolationlevel.isolation.dirtyread.BaseDirtyRead;
...
public class DirtyReadControllerTest extends BaseIsolationControllerTest {
    ...
    public void setupAll() {
        ...
        System.out.println("---------------------------------------------");
        System.out.println("[Не возникает Dirty Read]  Значение " + expectOccur.getCorrectTotalAmount());   // -300
        System.out.println("[Возникает Dirty Read]     Значение " + expectOccur.getIncorrectTotalAmount()); // 200
        System.out.println("=============================================");
    }
