...
public class LostUpdateControllerTest extends BaseIsolationControllerTest {
    ...
    public void setupAll() {
        ...
        System.out.println("|                 | Commit           |");
        System.out.println("--------------------------------------");
        System.out.println("[Не возникает Lost Update]  Значение " + expectOccur.getCorrectQuantity());    // 5
        System.out.println("[Возникает Lost Update]     Значение " + expectOccur.getIncorrectQuantity());  // 9
        System.out.println("======================================");
    }
